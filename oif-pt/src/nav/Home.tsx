                ...
                <div className='col'>
                    <div className='card'>
                        ...
                        <div className='card-body'>
                            ...
                            <p>
                                This application is an OpenC2 Orchestrator. The Device repository can be found&nbsp;
                    ...
                    <div className='card'>
                        ...
                        <div className='card-body p-0'>
                            <ul className="list-group">
                                <a className="list-group-item list-group-item-action" href={NAV_EXTERNAL_HTTPS} rel="noopener noreferrer" target="_blank">HTTPS</a>
